...
test('adds each annotation kind via the toolbar', async ({ page }) => {
  ...
  await expect(page.locator('.annotation-text').first()).toBeVisible();
  await expect(page.locator('.annotation-rect').first()).toBeVisible();
  await expect(page.locator('.annotation-ellipse').first()).toBeVisible();
  await expect(page.locator('.annotation-line').first()).toBeVisible();
